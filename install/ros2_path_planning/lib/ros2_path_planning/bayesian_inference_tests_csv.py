...
from bayesian_inference_planner import Bayesian_Inference_Planner
...
def teste():
    cones_raw = np.genfromtxt('mapa.csv',delimiter=',',skip_header=1)
    gains = Bayesian_Inference_Gains(4,0,0,20,0)
